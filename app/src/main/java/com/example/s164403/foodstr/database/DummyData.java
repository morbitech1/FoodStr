...
public class DummyData {
    ...
    public static List<Task> dummyRecipeTasks() {
        ...
        dummyTasks.add(new Task(1, "Prepare ingredients", 10, true, false, Arrays.asList((long) 1),"Finely chop onion, carrots, and celery sticks. Chop the pancetta into cubes, and chop the chicken liver while removing fat and sinew."));
        ...
        dummyTasks.add(new Task(2, "Prepare ingredients for veggies", 12, true, false, new ArrayList<Long>(), "Chop onion, separate the garlic into cloves, chop sweet potatoes, parsnips and carrots into chunks. Preheat oven."));
